...
public interface UserService {
    ...
    XgResult checkUserDate(/**@PathParam("param")*/String data, /**@PathParam("type")*/Integer type, String callback);
    ...
    //@GET
    //@Path("/token/{token}")
    XgResult token(/**@PathParam("token")*/String token, String callback);
    ...
    //@GET
    //@Path("/logout/{token}")
    XgResult logout(/**@PathParam("token")*/String token, String callback);
    ...
    XgResult validateUser(/**@PathParam("isEngaged")*/String isEngaged, String regName, String email, String phone);
